...
func registerStandardFunctions(fh handler.FunctionRegistry, rp *appyamlkit.AppConfigYAMLResourceProviderType) {
...
func initStandardFunctions(rp *appyamlkit.AppConfigYAMLResourceProviderType) {
