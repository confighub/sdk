...
func registerVetValues(fh handler.FunctionRegistry, converter configkit.ConfigConverter, resourceProvider yamlkit.ResourceProvider) {
	...
	if err := fh.RegisterFunction("vet-values", &handler.FunctionRegistration{
		...
		Function: func(fArgs handler.FunctionImplementationArguments) (gaby.Container, any, error) {
			return genericFnVetValues(resourceProvider, fArgs.ParsedData, fArgs.Arguments, fArgs.Options)
		},
	}); err != nil {
...
func genericFnVetValues(resourceProvider yamlkit.ResourceProvider, parsedData gaby.Container, args []api.FunctionArgument, options *api.FunctionOptions) (gaby.Container, any, error) {
	...
	result, err := GenericVetValues(resourceProvider, parsedData, attributeName, &filter, options)
...
// can call it.
func GenericVetValues(resourceProvider yamlkit.ResourceProvider, parsedData gaby.Container, attributeName api.AttributeName, filter *api.ValueFilter, options *api.FunctionOptions) (api.ValidationResult, error) {
