...
func registerStandardFunctions(fh handler.FunctionRegistry, rp *propkit.PropertiesResourceProviderType) {
	generic.RegisterStandardFunctions(fh, rp, rp)
}

func initStandardFunctions(rp *propkit.PropertiesResourceProviderType) {
