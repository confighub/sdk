...
func (o *GetUserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /user/{user_id}] GetUser", response, response.Code())
	}
}
...
func (o *GetUserOK) Error() string {
	...
	return fmt.Sprintf("[GET /user/{user_id}][%d] getUserOK %s", 200, payload)
}
...
func (o *GetUserOK) GetPayload() *models.ModelsUser {
	return o.Payload
}
...
func (o *GetUserBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user/{user_id}][%d] getUserBadRequest %s", 400, payload)
}
...
func (o *GetUserBadRequest) GetPayload() *models.ModelsErrorMessage {
	return o.Payload
}
...
func (o *GetUserUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user/{user_id}][%d] getUserUnauthorized %s", 401, payload)
}
...
func (o *GetUserUnauthorized) GetPayload() *models.ModelsErrorMessage {
	return o.Payload
}
...
func (o *GetUserForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user/{user_id}][%d] getUserForbidden %s", 403, payload)
}
...
func (o *GetUserForbidden) GetPayload() *models.ModelsErrorMessage {
	return o.Payload
}
...
func (o *GetUserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user/{user_id}][%d] getUserNotFound %s", 404, payload)
}
...
func (o *GetUserNotFound) GetPayload() *models.ModelsErrorMessage {
	return o.Payload
}
...
func (o *GetUserInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /user/{user_id}][%d] getUserInternalServerError %s", 500, payload)
}
...
func (o *GetUserInternalServerError) GetPayload() *models.ModelsErrorMessage {
	return o.Payload
}
