...
// WithLinkID adds the linkID to the delete link params
func (o *DeleteLinkParams) WithLinkID(linkID string) *DeleteLinkParams {
	o.SetLinkID(linkID)
	return o
}

// SetLinkID adds the linkId to the delete link params
func (o *DeleteLinkParams) SetLinkID(linkID string) {
	o.LinkID = linkID
}

// WithSpaceID adds the spaceID to the delete link params
func (o *DeleteLinkParams) WithSpaceID(spaceID string) *DeleteLinkParams {
	o.SetSpaceID(spaceID)
	return o
}

// SetSpaceID adds the spaceId to the delete link params
func (o *DeleteLinkParams) SetSpaceID(spaceID string) {
	o.SpaceID = spaceID
}
