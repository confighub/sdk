...
// WithSpace adds the space to the update space params
func (o *UpdateSpaceParams) WithSpace(space *models.ModelsSpace) *UpdateSpaceParams {
	o.SetSpace(space)
	return o
}

// SetSpace adds the space to the update space params
func (o *UpdateSpaceParams) SetSpace(space *models.ModelsSpace) {
	o.Space = space
}
