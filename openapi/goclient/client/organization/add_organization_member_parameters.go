...
type AddOrganizationMemberParams struct {
	...
	/* Member.
	   ...
	   Organization Member
	*/
	Member *models.ModelsOrganizationMember
...
func (o *AddOrganizationMemberParams) WithMember(member *models.ModelsOrganizationMember) *AddOrganizationMemberParams {
	o.SetMember(member)
	return o
}

// SetMember adds the member to the add organization member params
func (o *AddOrganizationMemberParams) SetMember(member *models.ModelsOrganizationMember) {
	o.Member = member
}

// WithOrganizationID adds the organizationID to the add organization member params
func (o *AddOrganizationMemberParams) WithOrganizationID(organizationID string) *AddOrganizationMemberParams {
	o.SetOrganizationID(organizationID)
	return o
}

// SetOrganizationID adds the organizationId to the add organization member params
func (o *AddOrganizationMemberParams) SetOrganizationID(organizationID string) {
