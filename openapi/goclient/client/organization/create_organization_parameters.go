...
func (o *CreateOrganizationParams) WithOrganization(organization *models.ModelsOrganization) *CreateOrganizationParams {
	o.SetOrganization(organization)
	return o
}

// SetOrganization adds the organization to the create organization params
func (o *CreateOrganizationParams) SetOrganization(organization *models.ModelsOrganization) {
