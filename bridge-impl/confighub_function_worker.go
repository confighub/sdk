...
func NewConfigHubFunctionWorker() *ConfigHubFunctionWorker {
	...
	funcimpl.RegisterConfigHub(fh)
	// Register custom functions
	registerCustomFunctions(fh)
	return &ConfigHubFunctionWorker{
		fh: fh,
	}
}

func (fw ConfigHubFunctionWorker) Info() api.FunctionWorkerInfo {
...
func (fw ConfigHubFunctionWorker) Invoke(workerCtx api.FunctionWorkerContext, request funcApi.FunctionInvocationRequest) (funcApi.FunctionInvocationResponse, error) {
...
var _ api.FunctionWorker = (*ConfigHubFunctionWorker)(nil)
