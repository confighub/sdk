...
For a working hello-world bridge example, see [hello-world-bridge](https://github.com/confighub/examples/tree/main/custom-workers/hello-world-bridge) in the examples repo.
