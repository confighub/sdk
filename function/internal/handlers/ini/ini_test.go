...
func TestVetJSONSchema_ValidINI(t *testing.T) {
	...
	yamlBytes, err := inikit.INIResourceProvider.NativeToYAML([]byte(validINI))
...
func TestVetJSONSchema_InvalidINI_MissingRequired(t *testing.T) {
	...
	yamlBytes, err := inikit.INIResourceProvider.NativeToYAML([]byte(invalidINI_MissingRequired))
	require.NoError(t, err)
...
func TestVetJSONSchema_InvalidINI_InvalidVersion(t *testing.T) {
	...
	yamlBytes, err := inikit.INIResourceProvider.NativeToYAML([]byte(invalidINI_InvalidVersion))
	require.NoError(t, err)
...
func TestVetJSONSchema_InvalidINI_InvalidPort(t *testing.T) {
	...
	yamlBytes, err := inikit.INIResourceProvider.NativeToYAML([]byte(invalidINI_WrongSchema))
	require.NoError(t, err)
