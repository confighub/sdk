...
func GetFunctionList(transportConfig *TransportConfig, toolchain workerapi.ToolchainType) (map[string]api.FunctionSignature, error) {
	// Send the request
	...
	var respMsg map[string]api.FunctionSignature
