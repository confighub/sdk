...
func (rp *PropertiesResourceProviderType) ResourceNameStableCoreGetter(doc *gaby.YamlDoc) (api.ResourceName, error) {
...
func (rp *PropertiesResourceProviderType) DeleteResourceID(doc *gaby.YamlDoc) error {
	resourceIDPath := rp.ContextPath(constants.ResourceIDKeySuffix)
	return doc.DeleteP(resourceIDPath)
}

func (rp *PropertiesResourceProviderType) ResourceMergeIDGetter(doc *gaby.YamlDoc) (string, error) {
...
func (rp *PropertiesResourceProviderType) SetResourceMergeID(doc *gaby.YamlDoc, id string) error {
	resourceMergeIDPath := rp.ContextPath(constants.ResourceMergeIDKeySuffix)
	_, err := doc.SetP(id, resourceMergeIDPath)
	return err
}

func (rp *PropertiesResourceProviderType) DeleteResourceMergeID(doc *gaby.YamlDoc) error {
	resourceMergeIDPath := rp.ContextPath(constants.ResourceMergeIDKeySuffix)
