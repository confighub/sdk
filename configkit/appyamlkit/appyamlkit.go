...
func (rp *AppConfigYAMLResourceProviderType) ResourceNameStableCoreGetter(doc *gaby.YamlDoc) (api.ResourceName, error) {
...
func (rp *AppConfigYAMLResourceProviderType) DeleteResourceID(doc *gaby.YamlDoc) error {
	resourceIDPath := rp.ContextPath(constants.ResourceIDKeySuffix)
	return doc.DeleteP(resourceIDPath)
}

func (rp *AppConfigYAMLResourceProviderType) ResourceMergeIDGetter(doc *gaby.YamlDoc) (string, error) {
...
func (rp *AppConfigYAMLResourceProviderType) SetResourceMergeID(doc *gaby.YamlDoc, id string) error {
	resourceMergeIDPath := rp.ContextPath(constants.ResourceMergeIDKeySuffix)
	_, err := doc.SetP(id, resourceMergeIDPath)
	return err
}

func (rp *AppConfigYAMLResourceProviderType) DeleteResourceMergeID(doc *gaby.YamlDoc) error {
	resourceMergeIDPath := rp.ContextPath(constants.ResourceMergeIDKeySuffix)
...
func (*AppConfigYAMLResourceProviderType) NativeToYAML(data []byte) ([]byte, error) {
	...
	if err != nil {
		return data, nil // If parse fails, return as-is
	}
