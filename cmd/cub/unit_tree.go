...
Default columns for hybrid view: Status, UpgradeNeeded, UnreleasedChanges, ValidationErrors
...
func getTreeColumns() []string {
	...
	defaultTreeColumns := []string{"UpgradeNeeded", "UnreleasedChanges", "Unit.ValidationErrors"}
