...
- Organization Slug (e.g., "org_01jdqp70m348z3m2fk7zks9q1a")
- Organization ID (ConfigHub UUID, e.g., "2af2356f-8587-4816-8619-77dfa85fb524")
- External ID (WorkOS ID, e.g., "org_01JDQP70M348Z3M2FK7ZKS9Q1A")
...
Examples:
  ...
  cub auth switch "org_01jdqp70m348z3m2fk7zks9q1a"
  
  # Switch to organization by partial name
  cub auth switch "brian@confighub"`,
